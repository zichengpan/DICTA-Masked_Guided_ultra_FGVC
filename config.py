...
class LoadConfig(object):
    def __init__(self, args, version):
        ...
        if args.dataset == 'product':
            ...
            self.dataset = args.dataset
            self.rawdata_root = './datasets/disease'
            self.anno_root = '/home/deep/Desktop/pan/Combination/DCL-master/datasets/Custom'
            self.numcls = 4
        else:
        ...
        self.mask_guide = True
        self.two_mask_guide = False
        self.use_dcl = False
