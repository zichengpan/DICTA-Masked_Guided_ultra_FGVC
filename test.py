...
def parse_args():
    ...
    parser.add_argument('--save', dest='resume',
                        default="/home/deep/Desktop/pan/Combination/DCL-master/net_model/_72119_CottonVein/weights_206_14_0.6208_0.7875.pth", type=str)
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        for batch_cnt_val, data_val in enumerate(dataloader):
            ...
            # tsne_output=outputs[1].cpu().numpy()
    ...
    # tsne = TSNE(n_components=2, verbose=1, random_state=123).fit_transform(tsne_output)
    # tx = tsne[:, 0]
    # ty = tsne[:, 1]
    #
